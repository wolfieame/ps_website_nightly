    ...
    <div class="content-data flex items-center justify-center flex-col">
      ...
      <div class="flex items-start flex-row mt-4 coloumn-sec">
        ...
        <div class="flex right-side flex-col">
          As the world continues to embrace innovative solutions, Primeskills,
          and Petra Digital Institute have joined forces to create innovative
          learning using Visual Novels and Virtual Reality. Through this unique
          approach, users are immersed in an interactive story that makes the
          learning modules even more intriguing. 
          <br /><br />
          By incorporating emotions and character choices, users are actively
          involved in shaping their learning journey. The inclusion of
          interactive comic visuals further enhances the excitement and interest
          in the learning modules.
          <br /><br />
          With this collaboration, Petra Digital Institute and Primeskills are
          revolutionizing the way knowledge is acquired by introducing a dynamic
          and immersive learning experience that captivates learners and
          promotes active engagement. The combination of Visual Novel and
          Virtual Reality opens up new possibilities for effective and enjoyable
          learning, paving the way for a brighter future of education.
        </div>
      </div>
